...
print ("<script> 
		<![CDATA[
			...
			function calcularDescontoIRRF(salario) {
				...
				var ALIQUOTA_07	= {de: 1903.99, ate: 2826.65, deducao: 142.80};
				var ALIQUOTA_15	= {de: 2826.66, ate: 3751.05, deducao: 354.80};	
				var ALIQUOTA_22	= {de: 3751.06, ate: 4664.68, deducao: 636.13};	
				var ALIQUOTA_27	= {de: 4664.69, deducao: 869.36};	
			  
				if (salario >= ALIQUOTA_00.de && salario <= ALIQUOTA_00.ate) {
					return 0;
				} else if (salario >= ALIQUOTA_07.de && salario <= ALIQUOTA_07.ate) {
					return (salario * 0.075) - ALIQUOTA_07.deducao;
				} else if (salario >= ALIQUOTA_15.de && salario <= ALIQUOTA_15.ate) {
					return (salario * 0.15) - ALIQUOTA_15.deducao;
				} else if (salario >= ALIQUOTA_22.de && salario <= ALIQUOTA_22.ate) {
					return (salario * 0.225) - ALIQUOTA_22.deducao;
				} else if (salario >= ALIQUOTA_27.de) {
					return (salario * 0.275) - ALIQUOTA_27.deducao;
				}
			}
